...
public class MenuScreen extends AbstractGameScreen {
	...
	private void showMenuButtons(boolean visible) {
		...
		btnMenuOptions.addAction(sequence(delay(delayOptionButton), moveBy(moveX, moveY, moveDuration, moveEasing)));

		SequenceAction seq = sequence();
		if(visible) seq.addAction(delay(delayOptionButton * moveDuration));
		seq.addAction(delay(delayOptionButton + moveDuration));
